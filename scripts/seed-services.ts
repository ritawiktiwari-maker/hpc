...
With warranties ranging from 5 to 10 years and annual inspection included, our termite management service gives you complete peace of mind. Our trained technicians ensure minimal disruption to your daily life while delivering maximum protection against termite infestations.`,
  ...
  },
  {
    ...
    description: `Household pests like cockroaches, ants, spiders, and silverfish are not just a nuisance — they carry diseases and contaminate food. HPC Pest Lifecare Pvt Ltd offers comprehensive household pest management services designed to keep your home in Ranchi clean, hygienic, and pest-free.
...
We offer flexible quarterly and monthly plans to suit your needs and budget. Our trained professionals conduct a detailed inspection before every treatment to identify pest hotspots and customize the approach accordingly. Enjoy a pest-free home with HPC's trusted household pest management service.`,
  ...
  },
  {
    ...
    description: `Bed bugs are persistent pests that hide in mattresses, furniture crevices, and bed frames, causing itchy bites and sleepless nights. HPC Pest Lifecare Pvt Ltd provides a thorough bed bug management solution that targets every stage of the bed bug lifecycle for complete elimination.
...
Every bed bug treatment includes a scheduled follow-up visit to ensure 100% elimination. We stand behind our work with a complete elimination guarantee, making HPC Pest Lifecare the trusted choice for bed bug control in Ranchi and Jharkhand.`,
    features: [
  ...
  },
  {
    ...
    description: `Rodents such as rats and mice pose serious health risks by contaminating food, spreading diseases, and damaging property through gnawing on wires, pipes, and structures. HPC Pest Lifecare Pvt Ltd delivers professional rodent management solutions for homes, offices, warehouses, and commercial establishments in Ranchi.
...
With monthly monitoring visits, we ensure that rodent activity is tracked and controlled on an ongoing basis. Whether you are dealing with a sudden infestation or need a long-term rodent prevention plan, HPC Pest Lifecare has the expertise and tools to keep your space rodent-free.`,
    features: [
...
Whether it is your home garden, housing society, office campus, or commercial premises, our mosquito management program provides comprehensive coverage and significantly reduces mosquito populations. Regular treatments during peak mosquito seasons ensure continuous protection against mosquito-borne diseases.`,
  ...
  },
  {
    ...
    description: `Cockroaches are one of the most common and resilient pests found in kitchens, restaurants, food processing units, and homes. They carry bacteria and allergens that can cause food poisoning, asthma, and other health issues. HPC Pest Lifecare Pvt Ltd offers specialized cockroach management solutions using the latest gel baiting technology and spray treatments.
...
The treatments we use provide a long-lasting effect, continuing to work for weeks after application. HPC Pest Lifecare's cockroach management is trusted by households, restaurants, hotels, and food businesses across Ranchi for effective and safe cockroach control.`,
    features: [
  ...
  },
  {
    ...
    description: `Wood borers are insects whose larvae feed on wood, creating tunnels and weakening wooden furniture, doors, window frames, and structural timber. If left untreated, wood borer damage can be extensive and costly. HPC Pest Lifecare Pvt Ltd provides expert wood borer management services to protect your valuable wooden assets in Ranchi.
...
With a 5-year warranty on our wood borer treatment, you can trust HPC Pest Lifecare to safeguard your furniture, doors, and wooden structures. Our experienced technicians assess the extent of damage and recommend the most effective treatment plan for your specific situation.`,
    features: [
  ...
  },
  {
    ...
    description: `Snakes can be a frightening and dangerous presence around homes, gardens, farmhouses, and commercial properties, especially in areas like Ranchi with green surroundings and open spaces. HPC Pest Lifecare Pvt Ltd provides professional snake management solutions that keep snakes away without harming them or the environment.
...
For emergency situations, our team provides rapid response to safely remove snakes from your premises. We also offer ongoing maintenance treatments to ensure continuous protection throughout the year. Trust HPC Pest Lifecare for humane, effective, and eco-friendly snake management in Ranchi.`,
    features: [
  ...
  },
  {
    ...
    description: `Bees play a vital role in our ecosystem, but when they build hives near homes, offices, or public spaces, they can pose a safety risk. HPC Pest Lifecare Pvt Ltd offers a specialized Bee Safe Service that focuses on the safe removal and relocation of bee hives without harming the bees.
...
We offer same-day service for urgent bee situations and our team is available for both residential and commercial properties across Ranchi. Choose HPC Pest Lifecare's Bee Safe Service for responsible, humane, and professional bee management.`,
    features: [
      'Safe Bee Removal',
      'Hive Relocation',
      'No Harm to Bees',
...
With monthly maintenance plans available, HPC Pest Lifecare ensures your garden, lawn, commercial landscape, or compound remains weed-free throughout the year. Our experienced team serves residential societies, corporate campuses, parks, and individual homes across Ranchi.`,
    features: [
  ...
  },
  {
    ...
    description: `Flies are a major hygiene concern, especially in restaurants, kitchens, food courts, hospitals, and food processing facilities. They carry pathogens that can cause food contamination and spread diseases like typhoid, cholera, and dysentery. HPC Pest Lifecare Pvt Ltd provides specialized fly management solutions designed for commercial and residential spaces in Ranchi.
...
Regular monitoring visits ensure that fly populations remain under control, and our team adjusts the treatment approach based on seasonal patterns and specific challenges at your location. HPC Pest Lifecare is the preferred fly management partner for leading restaurants, hotels, and food businesses in Ranchi.`,
    features: [
      'UV Fly Traps',
      'Chemical Spray',
      'Drainage Treatment',
  ...
  },
  {
    ...
    description: `In the post-pandemic world, maintaining a sanitized and disinfected environment is more important than ever. HPC Pest Lifecare Pvt Ltd provides professional microbial disinfection services using hospital-grade disinfectants that eliminate 99.9% of bacteria, viruses, and other harmful microorganisms from surfaces and the air.
...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'I was troubled by cockroaches in my kitchen for months. Tried many home remedies but nothing worked. HPC Pest Lifecare used gel baiting treatment and within a week, the cockroach problem was completely solved. The chemicals they used were odorless and safe for my children. Very happy with their service and now I have an annual plan with them.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Our office was facing a serious mosquito problem, especially during the monsoon season. HPC Pest Lifecare carried out fogging and indoor residual spray treatment in our entire office premises. The difference was immediate and remarkable. We now have a quarterly contract with them and our employees are much more comfortable. Great service at a reasonable price.',
  ...
  },
  {
    ...
    rating: 4,
    text: 'We found a beehive in our balcony and were very scared. Called HPC Pest Lifecare and they came the same day. Their team carefully removed the hive and relocated the bees without harming them. I really appreciate their humane approach. The technicians were well-equipped and handled everything very professionally. Thank you HPC team!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'I run a clinic in Morabadi and hygiene is our top priority. HPC Pest Lifecare provides us regular microbial disinfection and pest management services. They provided us with a sanitization certificate which we display proudly. Their electrostatic spraying technology is impressive and covers every corner. I would recommend them to all healthcare facilities in Ranchi.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Bed bugs were making our life miserable. We could not sleep properly for weeks. HPC Pest Lifecare did a complete room treatment with steam and chemical spray. After the treatment and one follow-up visit, the bed bugs were completely gone. It has been 6 months now and there is no recurrence. Best pest control service in Ranchi without a doubt!',
